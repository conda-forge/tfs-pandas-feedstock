...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tfs-pandas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14595&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tfs-pandas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tfs-pandas` can be installed with:

```
conda install tfs-pandas
```

It is possible to list all of the versions of `tfs-pandas` available on your platform with:
